...
// https://gitlab.com/lodi-g/spotify-control-chrome-extension-backend
...
const settings = require('./_utils/settings.json');
...
export default async (req, res) => {
    ...
    let { artist, track } = req.body // JSON.parse(req.body.toString("utf8"))
